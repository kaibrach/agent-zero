# Nova - Setup and Deployment

## Docker Deployment (Standard)

Nova is distributed as a Docker image: `agent0ai/agent-zero`.
...
Nova is a Progressive Web App (PWA). On mobile, open the web UI URL in a browser, then add to home screen for an app-like experience. Works with both local network and tunnel URLs.

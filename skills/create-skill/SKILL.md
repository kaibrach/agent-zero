---
name: "create-skill"
description: "Wizard for creating new Nova skills. Guides users through creating well-structured SKILL.md files. Use when users want to create custom skills."
version: "1.0.0"
author: "Nova Team"
...
This skill helps you create new Nova skills that follow the SKILL.md standard.

# Contributing Skills to Nova

Welcome to the Nova Skills ecosystem! This guide will help you create, test, and share skills with the community.
...
2. **Test Semantic Recall:**
   Start Nova and ask questions that should trigger your skill.

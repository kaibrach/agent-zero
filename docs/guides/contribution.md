...
Contributions to improve Nova are very welcome!  This guide outlines how to contribute code, documentation, or other improvements.
...
1. **Fork the Repository:** Fork the Nova repository on GitHub.
...
* **Code Style:** Follow the existing code style. Nova generally follows PEP 8 conventions.
...
2. **Create a Pull Request:** Create a pull request from your branch to the appropriate branch in the main Nova repository.

...
def print_troubleshooting():
    ...
    print("   - Make sure Nova is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Nova server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Nova server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Nova server if not running")

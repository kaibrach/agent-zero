...
class BackupService:
    """
    Core backup and restore service for Nova.
    ...
    def __init__(self):
        ...
        self.agent_zero_root = files.get_abs_path("")  # Resolved Nova root
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes Nova project directory patterns.
        """
...
"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up Nova root path with the current Nova root path
        ...
        for pattern in patterns:
            # Check if the pattern starts with the backed up Nova root
    ...
    def _translate_restore_path(self, archive_path: str, backup_metadata: Dict[str, Any]) -> str:
        ...
        # Check if the archive path starts with the backed up Nova root

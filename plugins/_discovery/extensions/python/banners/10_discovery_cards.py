...
class DiscoveryCardsExtension(Extension):
    ...
    async def execute(self, banners: list = [], frontend_context: dict = {}, **kwargs):
        ...
        banners.append({
            ...
            "description": "Extend Nova with integrations, tools, and automations from the community.",
        ...
        if not telegram_config.get("bot_token"):
            banners.append({
                ...
                "description": "Chat with Nova from Telegram wherever you are.",
        ...
        if not email_config.get("imap_username") and not email_config.get("smtp_username"):
            banners.append({
                ...
                "type": "feature",
                "title": "Setup Email",
                "description": "Let Nova read and send emails on your behalf.",

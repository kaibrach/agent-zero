...
- Nova is not a predefined agentic framework. It is designed to be dynamic, organically growing, and learning as you use it.
- Nova is fully transparent, readable, comprehensible, customizable, and interactive.
- Nova uses the computer as a tool to accomplish its (your) tasks.

# ⚙️ Installation

Click to open a video to learn how to install Nova:
...
A detailed setup guide for Windows, macOS, and Linux can be found in the Nova Documentation at [this page](./docs/setup/installation.md).
...
- Nova is not pre-programmed for specific tasks (but can be). It is meant to be a general-purpose personal assistant. Give it a task, and it will gather information, execute commands and code, cooperate with other agent instances, and do its best to accomplish it.
...
- Nova uses the operating system as a tool to accomplish its tasks. It has no single-purpose tools pre-programmed. Instead, it can write its own code and use the terminal to create and use its own tools as needed.
- The only default tools in its arsenal are online search, memory features, communication (with the user and other agents), and code/terminal execution. Everything else is created by the agent itself or can be extended by the user.
- Tool usage functionality has been developed from scratch to be the most compatible and reliable, even with very small models.
- **Default Tools:** Nova includes tools like knowledge, code execution, and communication.
- **Creating Custom Tools:** Extend Nova's functionality by creating your own custom tools.
...
1. **Nova Can Be Dangerous!**

- With proper instruction, Nova is capable of many things, even potentially dangerous actions concerning your computer, data, or accounts. Always run Nova in an isolated environment (like Docker) and be careful what you wish for.

2. **Nova Is Prompt-based.**
...
| [Extensions](./docs/developer/extensions.md) | Extending Nova |
